...
const Menu = (props) => {
  ...
  console.log("SOS", anecdoteById(1))
  console.log("Anecdotes", props.anecdotes)
  console.log("Props anecdoteById", props.anecdoteById("1"))
  console.log("Anecdote", anecdoteById("1"))
  //console.log("Content", anecdoteById(1).content)
